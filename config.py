...
DB_CHANNEL = {
     "-1003544512426": {"name": "Primary DB", "is_primary": True, "is_active": True},
     "-1003457468810": {"name": "Secondary DB", "is_primary": False, "is_active": True}
 }   # just put channel id dont add ""
